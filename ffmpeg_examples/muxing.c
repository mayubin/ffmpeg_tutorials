...
static void add_stream(OutputStream *ost, AVFormatContext *oc,
    ...
    *codec = avcodec_find_encoder(codec_id);
    ...
    /* Some formats want stream header to be separate. */
...
static void open_video(AVFormatContext *oc, AVCodec *codec, OutputStream *ost, AVDictionary *opt_arg) {
     ...
     * picture is needed too. It is then convert to the required
     * output format.
     */
    ost->tmp_frame = NULL;
    ...
    ret = avcodec_parameters_to_context(ost->st->codecpar, c);
    if (ret < 0) {
...
static void open_audio(AVFormatContext *oc, AVCodec *codec, OutputStream *ost, AVDictionary *opt_arg) {
    ...
    if ((ret = swr_init(ost->swr_ctx)) < 0) {
        fprintf(stderr, "Failed to initalize the resampling context\n");
        exit(1);
    }
}
